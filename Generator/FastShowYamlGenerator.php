...
namespace ACSEO\FastShowGeneratorBundle\Generator;
...
class FastShowYamlGenerator extends Generator
{
    private $filesystem;
    ...
    public function generate(BundleInterface $bundle, $entityClass, $entity, $group, $extension)
    {
        ...
        $dir = sprintf("%s/Resources/config/fastshow",$bundle->getPath());
        if (!file_exists($dir)) {
        ...
        $this->renderFile('fastshow/fastshow.yml.twig', $gridFile, $parameters);
    }
